...
This guide provides comprehensive documentation for the **linked-lists** skill in the custom-plugin-data-structures-algorithms plugin.
...
```bash
# Invoke the skill
claude "linked-lists - [your task description]"

# Example
claude "linked-lists - analyze the current implementation"
```
...
def implement_linked_lists(input_data):
    """
    Implement linked-lists functionality.
