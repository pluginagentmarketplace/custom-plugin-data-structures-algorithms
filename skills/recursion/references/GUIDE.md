...
This guide provides comprehensive documentation for the **recursion** skill in the custom-plugin-data-structures-algorithms plugin.
...
```bash
# Invoke the skill
claude "recursion - [your task description]"

# Example
claude "recursion - analyze the current implementation"
```
...
def implement_recursion(input_data):
    """
    Implement recursion functionality.
